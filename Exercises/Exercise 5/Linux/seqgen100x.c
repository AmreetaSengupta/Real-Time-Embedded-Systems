...
struct timespec wceti = {0, 0};
struct timespec wcetj = {0, 0};
...
{
    struct timeval current_time_val;
    struct timeval current_time_val1;
    struct timeval current_time_val2;
    double current_time;
    ...
    while(!abortS1)
    {
     ...
     //   gettimeofday(&current_time_val2, (struct timezone *)0);
