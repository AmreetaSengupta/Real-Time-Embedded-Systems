...
void *idleNoSem(void *threadid)
{
  ...
  do
  {
    ...
    idleCount[(long)threadid]++;
  } while(idleCount[(long)threadid] < runInterference);

  clock_gettime(CLOCK_REALTIME, &timeNow);
  printf("**** %ld idle NO SEM stopping at %ld sec, %ld nsec\n", (long)threadid, timeNow.tv_sec, timeNow.tv_nsec);
...
void *idle(void *threadid)
{
  ...
  clock_gettime(CLOCK_REALTIME, &timeNow);
  printf("**** %ld idle stopping at %ld sec, %ld nsec\n", (long)threadid, timeNow.tv_sec, timeNow.tv_nsec);
...
int main (int argc, char *argv[])
{
   ...
   pthread_attr_setaffinity_np(&rt_sched_attr[START_SERVICE], sizeof(cpu_set_t), &threadcpu);
   ...
   pthread_attr_setaffinity_np(&rt_sched_attr[HIGH_PRIO_SERVICE], sizeof(cpu_set_t), &threadcpu);
   ...
   pthread_attr_setaffinity_np(&rt_sched_attr[MID_PRIO_SERVICE], sizeof(cpu_set_t), &threadcpu);
   ...
   pthread_attr_setaffinity_np(&rt_sched_attr[LOW_PRIO_SERVICE], sizeof(cpu_set_t), &threadcpu);
